...
import { Deposited, Swapped } from "../generated/VaultSepoliaEth/Vault";
...
export function handleDepositedSepoliaEth(event: Deposited): void {
  handleDeposit(event, 11155111, "ETH");
}
export function handleDepositedSepoliaUsdc(event: Deposited): void {
  handleDeposit(event, 11155111, "USDC");
}
export function handleSwappedSepoliaEth(event: Swapped): void {
  handleSwap(event, 11155111, "ETH");
}
export function handleSwappedSepoliaUsdc(event: Swapped): void {
  handleSwap(event, 11155111, "USDC");
}
