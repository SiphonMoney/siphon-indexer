...
import { LeafInserted } from "../generated/MerkleTreeBaseEth/MerkleTree";
...
export function handleLeafInsertedBaseEth(event: LeafInserted): void {
  handleLeaf(event, 8453, "ETH");
}

export function handleLeafInsertedBaseUsdc(event: LeafInserted): void {
  handleLeaf(event, 8453, "USDC");
}
